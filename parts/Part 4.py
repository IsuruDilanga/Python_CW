...
marks_input = []
#creat details of marks.txt file 
details_of_marks = open("details of marks.txt", "w")
...
def histogram():
    ...
    for a in marks_input:
        print(a) #read all mark inputs
        
        details_of_marks.write(a + "\n") #append all inputs marks
    details_of_marks.close() #close appending details of marks.txt file
    
    print("\nfrom txt file: \n")

    all_marks = open("details of marks.txt", "r") #open txt file
    print(all_marks.read()) #show txt file data
    all_marks.close() 
