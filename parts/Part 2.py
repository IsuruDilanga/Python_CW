...
def histogram():
    ...
    for x in range(max_value):
        print(f'{progress_list[x]:>6}', end=" ")   #use f-string and make 5 spaces
        print(f'{trailer_list[x]:>9}', end=" ")    #use f-string and make 8 spaces
        print(f'{retriever_list[x]:>10}', end=" ")  #use f-string and make 8 spaces
        print(f'{excluded_list[x]:>10}')            #use f-string and make 8 spaces
